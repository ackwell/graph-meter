...
Data.prototype.push = function(detail) {
	...
	if (!this.encounter || this.encounter.isNewEncounter(detail)) {
		...
		// Don't need history if controls are hidden, though
		if (this.encounter && config.showControls) {
...
Data.prototype.updateHistoryControls = function(nameCurrent) {
	// Don't bother if controls are disabled
	...
	window.updateHistoryControls(controlEncounters, this.currentlyViewing === this.encounter);
}
